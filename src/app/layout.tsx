...
import './globals.css';
export const metadata: Metadata = { title: 'SU AQTAU — городская безопасность', description: 'Демонстрационная платформа городской безопасности Актау', manifest: '/manifest.webmanifest', applicationName: 'SU AQTAU' };
